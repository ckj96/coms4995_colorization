...
class ModelOptions:
    def __init__(self):
        ...
        parser.add_argument('--name', type=str, default='CGAN', help='arbitrary model name (default: CGAN should set '
                                                                     'to the test image name, relate to model name')
        parser.add_argument('--mode', default=0, help='run mode [0: train, 1: evaluate, 2: test] (default: 0)')
        parser.add_argument('--dataset', type=str, default='places365', help='the name of dataset '
                                                                             '[places365, cifar10] (default: places365)')
        ...
        parser.add_argument("--l1-weight", type=float, default=100.0, help="weight on L1 term for generator "
                                                                           "gradient (default: 100.0)")
        parser.add_argument('--augment', type=str2bool, default=True, help='True for augmentation (default: True)')
        parser.add_argument('--label-smoothing', type=str2bool, default=False, help='True for one-sided label '
        ...
        parser.add_argument('--save-interval', type=int, default=1000, help='how many batches to wait before saving'
                                                                            ' model (default: 1000)')
        ...
        parser.add_argument('--sample-interval', type=int, default=1000, help='how many batches to wait before '
                                                                              'sampling (default: 1000)')
        parser.add_argument('--validate', type=str2bool, default=True, help='True for validation (default: True)')
        parser.add_argument('--validate-interval', type=int, default=0, help='how many batches to wait before '
                                                                             'validating (default: 0)')
        parser.add_argument('--log', type=str2bool, default=False, help='True for logging (default: True)')
        parser.add_argument('--log-interval', type=int, default=10, help='how many iterations to wait before logging '
                                                                         'training status (default: 10)')
        parser.add_argument('--visualize', type=str2bool, default=False, help='True for accuracy visualization '
                                                                              '(default: False)')
        parser.add_argument('--visualize-window', type=int, default=100, help='the exponentially moving average window '
                                                                              'width (default: 100)')
        parser.add_argument('--test-size', type=int, default=100, metavar='N', help='number of Turing tests'
                                                                                    ' (default: 100)')
        parser.add_argument('--test-delay', type=int, default=0, metavar='N', help='number of seconds to wait when doing'
                                                                                   ' Turing test, 0 for unlimited'
                                                                                   ' (default: 0)')
